...
import s.com.eoi.conf.SnowflakeConf
...
/**
  ...
  */
object Snowflake {
  private val snowflake = SnowflakeConf()
  private val idGenerator = new SnowflakeIdGenerator(snowflake.worker_id().get)//, snowflake.datacenter_id().get)
